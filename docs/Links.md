...
1. [Структурированный синтаксис по java](http://proglang.su/java)
2. [Расширенный структурированный синтаксис по java](https://metanit.com/java/tutorial/2.10.php)
...
2. [Сайт в форме игры для обучения работы с Git](https://learngitbranching.js.org/?locale=ru_RU)
3. [Репозитории Maven](https://mvnrepository.com/)
4. [Создание документации с помощью Markdown](https://www.youtube.com/watch?v=FFBTGdEMrQ4)
